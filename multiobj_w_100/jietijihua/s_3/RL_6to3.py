    ...
    def step(self, action):
        ...
        if done == True:
            ...
            if self.jietidijibu == 25:
                ...
                reward = -sec_term_factor * 24 -1*24
...
def shinengjisuan(initial,end,feigao,jietidijibu,record_flying_height):
        ...
        if result != -1:
            ...
            if result == jietidijibu:
                ...
                cost_n_add =  24 - jietidijibu    # zongbushu = 25
                
                cost_n = cost_n + sec_term_factor * cost_n_add
